...
namespace JamesFrowen.CSP
{
    ...
    {
        private static Pool<TickNotifyToken> pool = new Pool<TickNotifyToken>((_, __) => new TickNotifyToken(), 0, 10, 1000, LogFactory.GetLogger<TickNotifyToken>());
        ...
        private ITickNotifyTracker tracker;
        private int tick;
